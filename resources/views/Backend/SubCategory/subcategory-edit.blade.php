    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid mt-5">
            ...
            <div class="card-body col-6 m-auto" style="border:1px solid #9DBEF2">
                <div class="card-title text-center">Edit SubCategory</div>
                ...
                <form action="{{ route('SubCategoryUpdate') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="subcategory_name" class="form-control @error('subcategory_name') is-invalid @enderror" id="subcategory_name" placeholder="Enter Your Category Name" value="{{ $subcategory->subcategory_name ?? old('subcategory_name') }}">
