...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('fontend/assets/css/woocommerce.css') }}">
                            ...
                            <div class="brand_logo">
                                <a class="brand_link" href="index.html">
                                    <img src="{{ asset('fontend/assets/images/logo/logo_1x.png') }}"
                                        srcset="fontend/assets/images/logo/logo_2x.png 2x" alt>
                                </a>
                            </div>
                        </div>
                                        ...
                                        <ul class="allcategories_list ul_li_block">
                                            ...
                                            <li>
                                                <a href="{{ route('ProductPage') }}">
                                                    <i class="icon icon-WorldWide"></i> Most
                                                    Popular Products
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="shop_list.html">
                                                    <i class="icon icon-Bulb"></i> Consumer
                                                    Electronics
                                                </a>
                                            </li>
                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-6">
                            <p class="copyright_text">
                                ©2022 <a href="#!">stowaa</a>. All Rights Reserved. <strong
                                    class="text-primary">Develop By Nazmul Islam</strong>
                            </p>
                        </div>
